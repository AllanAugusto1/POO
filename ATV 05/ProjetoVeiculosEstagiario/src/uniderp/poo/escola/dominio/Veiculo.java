...
public class Veiculo {
    ...
    public int getQtdeMorotes() {
        return qtdeMorotes;
    }
    public void setQtdeMorotes(int qtdeMorotes) {
        this.qtdeMorotes = qtdeMorotes;
    }
    ...
    String cidadeUF, String tipoVeiculo, int qtdeMorotes, int qtdeOcupantes){
